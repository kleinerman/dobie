...
class CrudMngr(genmngr.GenericMngr):
    ...
    def run(self):
        ...
        self.crudHndlrs = {'HC': self.dataBase.addDoor,
                           'HU': self.dataBase.updDoor,
                           'HD': self.dataBase.delDoor,
                           'AC': self.dataBase.addAccess,
                           'AU': self.dataBase.updAccess,
                           'AD': self.dataBase.delAccess,
                           'PC': self.dataBase.addLiAccess,
                           'PU': self.dataBase.updLiAccess,
                           'PD': self.dataBase.delLiAccess,
                           'RU': self.dataBase.updPerson,
                           'RD': self.dataBase.delPerson
                          }
