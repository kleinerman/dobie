...
#Static Persons
curl -u admin:admin -i -H "Content-Type: application/json" -X POST -d '{"names": "Jorge Emanuel", "lastName": "Kleinerman", "identNumber": "28063146", "note": "nota de prueba", "cardNumber": 5379295, "orgId": 2, "visitedOrgId": null, "isProvider": 0}' http://$BCKND_DOCKER_IP:5000/api/v1.0/person
...
curl -u admin:admin -i -H "Content-Type: application/json" -X POST -d '{"names": "German Andres", "lastName": "Fisanotti", "identNumber": "22063146", "note": "nota de prueba", "cardNumber": 9038876, "orgId": 2, "visitedOrgId": null, "isProvider": 0}' http://$BCKND_DOCKER_IP:5000/api/v1.0/person
curl -u admin:admin -i -H "Content-Type: application/json" -X POST -d '{"names": "Lucas", "lastName": "Ferre", "identNumber": "23063146", "note": "nota de prueba", "cardNumber": 9136307, "orgId": 2, "visitedOrgId": null, "isProvider": 0}' http://$BCKND_DOCKER_IP:5000/api/v1.0/person
curl -u admin:admin -i -H "Content-Type: application/json" -X POST -d '{"names": "Daniel", "lastName": "Costa", "identNumber": "24631946", "note": "nota de prueba", "cardNumber": 6036754, "orgId": 3, "visitedOrgId": null, "isProvider": 0}' http://$BCKND_DOCKER_IP:5000/api/v1.0/person
curl -u admin:admin -i -H "Content-Type: application/json" -X POST -d '{"names": "Romina", "lastName": "Goner", "identNumber": "25063146", "note": "nota de prueba", "cardNumber": 5327374, "orgId": 3, "visitedOrgId": null, "isProvider": 0}' http://$BCKND_DOCKER_IP:5000/api/v1.0/person
curl -u admin:admin -i -H "Content-Type: application/json" -X POST -d '{"names": "Carlos", "lastName": "Navares", "identNumber": "26063146", "note": "nota de prueba", "cardNumber": 5330640, "orgId": 3, "visitedOrgId": null, "isProvider": 0}' http://$BCKND_DOCKER_IP:5000/api/v1.0/person
