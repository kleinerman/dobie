...
All the information of the access shown in the above window can should be retrieved in the same way done above, sending an POST method to the person and using the information for the access that is going to be modified.
